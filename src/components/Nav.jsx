...
export default function Nav() {
    return (
        <Popover className="relative bg-cover" style={{ backgroundImage: `url(${bgImg})` }}>
            <div className="mx-auto px-4 sm:px-6">
                <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                    ...
                    <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                        ...
                        <Link to='/login' className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-indigo-900">Login</Link>
                        {/* <a
                            href="https://modernsolnhub.com/"
                            className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700" >
                            Register
                        </a> */}
                        <Link to='/register' className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">
                            Register
                        </Link>
                    </div>
                </div>
